...
public class MainBeanInfo extends SimpleBeanInfo {
    ...
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( Main.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            methods[METHOD_main0] = new MethodDescriptor(Main.class.getMethod("main", new Class[] {java.lang.String[].class})); // NOI18N
